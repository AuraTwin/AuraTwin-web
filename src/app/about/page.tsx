      ...
      <section className="bg-gradient-to-br from-primary-50 to-accent-50 dark:from-gray-900 dark:to-gray-900 pt-20 pb-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center animate-fadeIn">
            <h1 className="text-5xl md:text-6xl font-bold text-gray-900 dark:text-white mb-6">Our Mission</h1>
      ...
      <section className="py-20 bg-white dark:bg-gray-900">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8" data-reveal>
          <div className="bg-gradient-to-br from-primary-600 to-accent-600 p-12 rounded-2xl text-white text-center">
            <h2 className="text-3xl md:text-4xl font-bold mb-6">We believe everyone deserves to understand their emotions</h2>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
            {[
              ...
              <div key={member.name} className="bg-white dark:bg-gray-900 p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow" data-reveal data-reveal-delay={`${i * 80}`}>
                ...
                <p className="text-primary-600 dark:text-primary-400 text-center font-semibold mb-3">{member.role}</p>
                <p className="text-gray-600 dark:text-gray-400 text-center text-sm">{member.description}</p>
              </div>
            ))}
          </div>
          ...
          <div className="max-w-2xl mx-auto" data-reveal>
            <div className="bg-white dark:bg-gray-900 p-8 rounded-xl shadow-lg text-center">
              <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-2">Academic Advisor</h3>
              ...
              <h4 className="text-xl font-bold text-gray-900 dark:text-white mb-1">Doç. Dr. Mete Eminağaoğlu</h4>
              <p className="text-accent-600 dark:text-accent-400 font-semibold mb-4">Yaşar University - Computer Engineering Department</p>
      ...
      <section className="py-20 bg-white dark:bg-gray-900">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12" data-reveal>
            <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">Yaşar University</h2>
            <p className="text-lg text-gray-600 dark:text-gray-300">Computer Engineering Department</p>
          </div>

          <div className="bg-gradient-to-br from-gray-50 to-white dark:from-gray-800 dark:to-gray-800 p-8 rounded-2xl border border-gray-200 dark:border-gray-700" data-reveal>
            ...
            <div className="grid md:grid-cols-3 gap-6 mt-8">
              <div className="text-center p-4 bg-primary-50 dark:bg-primary-900/20 rounded-lg">
                ...
                <div className="text-sm text-gray-700 dark:text-gray-300">Development Time</div>
              </div>
              ...
              <div className="text-center p-4 bg-warm-50 dark:bg-warm-900/20 rounded-lg">
                <div className="text-3xl font-bold text-warm-600 mb-2">1 advisor</div>
                <div className="text-sm text-gray-700 dark:text-gray-300">Academic Supervision</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 bg-gray-50 dark:bg-gray-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16" data-reveal>
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">Principles that guide every decision we make</p>
          </div>

          <div className="grid md:grid-cols-3 gap-8">
            {[
              { title: 'Privacy First', body: 'Your data belongs to you. We build privacy into every feature from the ground up, not as an afterthought.', color: 'primary', icon: <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" /> },
              { title: 'Science-Backed', body: 'Every feature is grounded in research. We build on proven science, not hype or pseudoscience.', color: 'accent', icon: <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" /> },
              { title: 'User-Centric', body: 'We build for people, not metrics. Your well-being and experience guide our development priorities.', color: 'warm', icon: <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" /> },
              { title: 'Open & Transparent', body: "We're honest about what our technology can and cannot do. No marketing hype, just honest communication.", color: 'primary', icon: <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4" /> },
              { title: 'Continuous Improvement', body: "We're committed to ongoing research and development, constantly improving our technology and insights.", color: 'accent', icon: <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 21a4 4 0 01-4-4V5a2 2 0 012-2h4a2 2 0 012 2v12a4 4 0 01-4 4zm0 0h12a2 2 0 002-2v-4a2 2 0 00-2-2h-2.343M11 7.343l1.657-1.657a2 2 0 012.828 0l2.829 2.829a2 2 0 010 2.828l-8.486 8.485M7 17h.01" /> },
              { title: 'Accessibility', body: 'Emotional intelligence tools should be available to everyone, regardless of economic status or background.', color: 'warm', icon: <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3.055 11H5a2 2 0 012 2v1a2 2 0 002 2 2 2 0 012 2v2.945M8 3.935V5.5A2.5 2.5 0 0010.5 8h.5a2 2 0 012 2 2 2 0 104 0 2 2 0 012-2h1.064M15 20.488V18a2 2 0 012-2h3.064M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /> },
            ].map((value, i) => (
              <div key={value.title} className="bg-white dark:bg-gray-900 p-8 rounded-xl shadow-md" data-reveal data-reveal-delay={`${i * 80}`}>
                <div className={`w-12 h-12 bg-${value.color}-100 dark:bg-${value.color}-900/30 rounded-lg flex items-center justify-center mb-4`}>
                  <svg className={`w-6 h-6 text-${value.color}-600`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    {value.icon}
                  </svg>
                </div>
                <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-3">{value.title}</h3>
                <p className="text-gray-600 dark:text-gray-300">{value.body}</p>
              </div>
            ))}
          </div>
        </div>
